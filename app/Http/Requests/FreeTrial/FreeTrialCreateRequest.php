...
class FreeTrialCreateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            //'user_id' => 'required|numeric|unique:free_trials,user_id,NULL,id,free_trial_plan_id,'.$this->free_trial_plan_id, //unique with 2 columnd
